...
public class GameDataDao extends AbstractDao<GameData, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ShipId = new Property(8, Long.class, "shipId", false, "SHIP_ID");
    };
    ...
    public void readEntity(Cursor cursor, GameData entity, int offset) {
        ...
        entity.setShipId(cursor.isNull(offset + 8) ? null : cursor.getLong(offset + 8));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T1", daoSession.getShipDao().getAllColumns());
