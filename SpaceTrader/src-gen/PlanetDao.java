...
public class PlanetDao extends AbstractDao<Planet, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Radius = new Property(2, Integer.class, "radius", false, "RADIUS");
        ...
        public final static Property Color = new Property(8, Integer.class, "color", false, "COLOR");
    ...
    public void readEntity(Cursor cursor, Planet entity, int offset) {
        ...
        entity.setRadius(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
        ...
        entity.setColor(cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8));
