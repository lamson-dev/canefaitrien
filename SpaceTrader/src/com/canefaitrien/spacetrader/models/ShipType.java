...
public enum ShipType {
	...
	public static final int
		FIREFLY_DISTANCE = 17, 
		FIREFLY_HULL_STRENGTH = 200, 
		FIREFLY_WEAPON_SLOTS = 1, 
		FIREFLY_GADGET_SLOTS = 1, 
		FIREFLY_SHIELD_SLOTS = 1, 
		FIREFLY_CARGO_HOLD = 20, 
		FIREFLY_CREW = 0, 
		FIREFLY_MERCENARY = 0;//17, 200, 1, 1, 1, 20, 0, 0, "Firefly"),
	
	public static final int
		MOSQUITO_DISTANCE = 15, 
		MOSQUITO_HULL_STRENGTH = 300, 
		MOSQUITO_WEAPON_SLOTS = 2, 
		MOSQUITO_GADGET_SLOTS = 1, 
		MOSQUITO_SHIELD_SLOTS = 1, 
		MOSQUITO_CARGO_HOLD = 15, 
		MOSQUITO_CREW = 0, 
		MOSQUITO_MERCENARY = 0;//15, 300, 2, 1, 1, 15, 0, 0, "Mosquito"),
	
	public static final int
		BUMBLEBEE_DISTANCE = 15, 
		BUMBLEBEE_HULL_STRENGTH = 200, 
		BUMBLEBEE_WEAPON_SLOTS = 0, 
		BUMBLEBEE_GADGET_SLOTS = 2, 
		BUMBLEBEE_SHIELD_SLOTS = 2, 
		BUMBLEBEE_CARGO_HOLD = 20, 
		BUMBLEBEE_CREW = 0, 
		BUMBLEBEE_MERCENARY = 5;//15, 200, 0, 2, 2, 20, 0, 5, "Bumblebee"),
	
	public static final int
		BEETLE_DISTANCE = 14, 
		BEETLE_HULL_STRENGTH = 100, 
		BEETLE_WEAPON_SLOTS  = 0, 
		BEETLE_GADGET_SLOTS = 1, 
		BEETLE_SHIELD_SLOTS = 1, 
		BEETLE_CARGO_HOLD = 50, 
		BEETLE_CREW = 0, 
		BEETLE_MERCENARY = 0;//14, 100, 0, 1, 1, 50, 0, 0, "Beetle"),
	
	public static final int 
		HORNET_DISTANCE = 16, 
		HORNET_HULL_STRENGTH = 300, 
		HORNET_WEAPON_SLOTS = 3, 
		HORNET_GADGET_SLOTS = 1, 
		HORNET_SHIELD_SLOTS = 2, 
		HORNET_CARGO_HOLD = 20, 
		HORNET_CREW = 0, 
		HORNET_MERCENARY = 0;//16, 300, 3, 1, 2, 20, 0, 0, "Hornet"),
	
	public static final int 
		GRASSHOPPER_DISTANCE = 15, 
		GRASSHOPPER_HULL_STRENGTH = 200,
		GRASSHOPPER_WEAPON_SLOTS = 2, 
		GRASSHOPPER_GADGET_SLOTS = 3, 
		GRASSHOPPER_SHIELD_SLOTS = 2, 
		GRASSHOPPER_CARGO_HOLD = 30, 
		GRASSHOPPER_CREW = 3, 
		GRASSHOPPER_MERCENARY = 0;//15, 200, 2, 3, 2, 30, 3, 0, "Grasshopper")
	
	public static final int 
		TERMITE_DISTANCE = 13, 
		TERMITE_HULL_STRENGTH = 300, 
		TERMITE_WEAPON_SLOTS = 1, 
		TERMITE_GADGET_SLOTS = 2, 
		TERMITE_SHIELD_SLOTS = 3, 
		TERMITE_CARGO_HOLD = 60, 
		TERMITE_CREW = 3, 
		TERMITE_MERCENARY = 0;//13, 300, 1, 2, 3, 60, 3, 0, "Termite"),
	
	public static final int 
		WASP_DISTANCE = 14, 
		WASP_HULL_STRENGTH = 300, 
		WASP_WEAPON_SLOTS = 3, 
		WASP_GADGET_SLOTS = 2, 
		WASP_SHIELD_SLOTS = 2, 
		WASP_CARGO_HOLD = 35, 
